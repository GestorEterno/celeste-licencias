// terminos-y-condiciones-ocaso.js - Versión Mejorada

document.addEventListener('DOMContentLoaded', function() {
    console.log('Vision Olympus - Términos y Condiciones Ocaso cargados');
...
function initTermsPage() {
    console.log('Configurando página de términos y condiciones Ocaso...');
...
console.log('Términos y Condiciones Ocaso - Vision Olympus listos');
